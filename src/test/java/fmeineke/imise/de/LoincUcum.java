...
public class LoincUcum {
    ...
    static String[][] d = {
            ...
            {"{Ehrlich'U}/dL", "Ehrlich unit per deciliter"},
            {"{EIA_index}", "EIA index"},
            {"{EIA_titer}", "EIA titer"},
            {"{EIA'U}", "EIA unit"},
            ...
            {"eq/umol", "equivalent per micromole"},
            {"eq/mL", "equivalent per milliliter"},
            {"eq/mmol", "equivalent per millimole"},
            {"erg", "erg"},
            {"F", "Farad"},
            ...
            {"fmol/mL", "femtomole per milliliter"},
            ...
            {"kat/L", "katal per liter"},
            {"kU", "kilo enzyme unit"},
            {"kU/g", "kilo enzyme unit per gram"},
            {"kU/L", "kilo enzyme unit per liter"},
            ...
            {"L/min/m2", "liter per minute per sqaure meter"},
            ...
            {"um/s", "microns per second"},
            {"uOhm", "microOhm"},
            {"us", "microsecond"},
            {"uV", "microvolt"},
            {"[mi_i]", "mile (international)"},
            {"mU/g", "milli  enzyme unit per gram"},
            {"mU/mL", "milli  enzyme unit per milliliter"},
            {"mU/mL/min", "milli  enzyme unit per milliliter per minute"},
            ...
            {"mU/L", "milli enzyme unit per liter"},
            {"mU/mg", "milli enzyme unit per milligram"},
            ...
            {"mL/(8.h)/kg", "milliliter per 8 hour per kilogram"},
            ...
            {"min", "minute"},
            {"min/d", "minute per day"},
            {"min/wk", "minute per week"},
            {"mol", "mole"},
            ...
            {"nmol/mmol{creat}", "nanomole bone collagen equivalent per millimole of creatinine"},
            {"nmol/mg{prot}", "nanomole of 1/2 cystine per milligram of protein"},
            ...
            {"nmol/mg{prot}/h", "nanomole per milligram of protein per hour"},
